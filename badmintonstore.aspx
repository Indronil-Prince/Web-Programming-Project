<%@ Page Language="C#" AutoEventWireup="true" CodeFile="badmintonstore.aspx.cs" Inherits="badmintonstore" %>
...
<div class="mySlides fade">
  <img src="images/badminton_banner.jpg" style="width:100%">
</div>

<div class="mySlides fade">
  <img src="images/badminton_banner(1).jpg" style="width:100%">
</div>

<div class="mySlides fade">
  <img src="images/badminton_banner(2).jpg" style="width:100%">
</div>
...
<div id="wrapper" style="background-image: url(images/back_badminton.jpg);
    ...
    background-size: cover;">																															
		<div id="content_inside">
			<div id="main_block">
				<h2 style="padding-bottom: 20px; font-size: 32px; color: white" class="auto-style6">BADMINTON STORE</h2>
                <div>
                    <div id="search">

                        <span class="auto-style6">:</span> <asp:TextBox ID="TextBox1" runat="server" Height="21px" Width="172px" style="padding-left:8px; border-radius:50px; -webkit-border-radius: 50px; -moz-border-radius: 50px;"></asp:TextBox>&nbsp;<asp:Button ID="Button1" runat="server" Text="Search" OnClick="Search" BorderStyle="Solid" style="color: #FFFFFF; font-weight: 700; padding: 3px;" CssClass="btnqq" BorderWidth="2px"/>
