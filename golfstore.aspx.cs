...
public partial class golfstore : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (url != "http://localhost:2521/golfstore.aspx")
        {
            string value = Request.QueryString["search"].ToString();
            SqlDataSource1.SelectCommand = "SELECT * FROM [product] WHERE [store] = 'Golf' and ([product_name] like '%" + value + "%' or [type] like '%" + value + "%' or [category] like '%" + value + "%' or [brand] like '%" + value + "%') ORDER BY [category] DESC, [type], [brand], [product_name]";
        }
        else {
            SqlDataSource1.SelectCommand = "SELECT * FROM [product] WHERE [store] = 'Golf' and category='Jersey' ORDER BY [category] DESC, [type], [brand], [product_name] ;";
            Category1.Text = "⚫ Jersey";
            SqlDataSource2.SelectCommand = "SELECT * FROM [product] WHERE [store] = 'Golf' and category='Shoes' ORDER BY [category] DESC, [type], [brand], [product_name] ;";
            Category2.Text = "⚫ Shoe";
            SqlDataSource3.SelectCommand = "SELECT * FROM [product] WHERE [store] = 'Golf' and type='Driver' ORDER BY [category] DESC, [type], [brand], [product_name] ;";
            Category3.Text = "⚫ Driver";
            SqlDataSource4.SelectCommand = "SELECT * FROM [product] WHERE [store] = 'Golf' and type='Chipper' ORDER BY [category] DESC, [type], [brand], [product_name] ;";
            Category4.Text = "⚫ Chipper";
            SqlDataSource5.SelectCommand = "SELECT * FROM [product] WHERE [store] = 'Golf' and type='Putter' ORDER BY [category] DESC, [type], [brand], [product_name] ;";
            Category5.Text = "⚫ Putter";
        }
    }
    ...
    protected void Search(object sender, EventArgs e)
    {
        ...
        Response.Redirect("golfstore.aspx?search=" + str);
    }
    protected void div1_button(object sender, EventArgs e)
    {
        ...
        DataList5.Style.Add("display", "none"); Category5.Style.Add("font-size", "medium");
    }
    ...
    protected void div5_button(object sender, EventArgs e)
    {
        DataList5.Style.Add("display", "block"); Category5.Style.Add("font-size", "x-large");
        DataList1.Style.Add("display", "none"); Category1.Style.Add("font-size", "medium");
        DataList2.Style.Add("display", "none"); Category2.Style.Add("font-size", "medium");
        DataList3.Style.Add("display", "none"); Category3.Style.Add("font-size", "medium");
        DataList4.Style.Add("display", "none"); Category4.Style.Add("font-size", "medium");
