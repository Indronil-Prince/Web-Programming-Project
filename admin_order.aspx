<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_order.aspx.cs" Inherits="admin_order" %>
...
<body>
      ...
      <ul id="menu0" style="top:40px">
       ...
       <asp:Button Class="admbtn" runat="server" Text="Log Out" ID="Button12" OnClick="logout"></asp:Button>
             ...
             <div style="margin-top:120px;">
                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SportsShopOnlineConnectionString %>" SelectCommand="SELECT DISTINCT [order_id], [name], [location], [district], [phone], [OrderDate], [status] FROM [orderTable] ORDER BY [OrderDate] desc"></asp:SqlDataSource>
                 <strong>
                 <asp:Table runat="server" Width="1020px" CssClass="auto-style36" BackColor="Black" ForeColor="White">
                                    <asp:TableRow>
                                <asp:TableCell Width="100px" style="padding-left:4px; padding-bottom:4px; padding-top:4px;">ORDER ID
                                </asp:TableCell><asp:TableCell Width="150px">NAME
                                </asp:TableCell><asp:TableCell Width="180px">LOCATION
                                </asp:TableCell><asp:TableCell Width="100px">DISTRICT
                                </asp:TableCell><asp:TableCell Width="100px">PHONE NO.
                                </asp:TableCell><asp:TableCell Width="130px">DATE OF ORDER
                                </asp:TableCell><asp:TableCell Width="120px">STATUS
                        ...
                        <ItemTemplate>
                            <div class="auto-style10">
                                ...
                                <asp:Table runat="server" Width="1021px" GridLines="None">
                                    <asp:TableRow>
                                <asp:TableCell Width="100px" style="padding-left:3px;"><a href="javascript:Openpopup('order.aspx?Order_id=<%# Eval("order_id") %>&Status=Cofirmed')" style="text-decoration:none;"><asp:Label ID="idLabel" runat="server" Text='<%# Eval("order_id")%>' ForeColor="Red" /></a>
                                </asp:TableCell><asp:TableCell Width="150px"><span><asp:Label ID="nameLabel" runat="server" CssClass="auto-style12" Text='<%# Eval("name") %>' />
                                </asp:TableCell><asp:TableCell Width="180px"><asp:Label ID="locationLabel" runat="server" CssClass="auto-style12" Text='<%# Eval("location") %>' />
                                </asp:TableCell><asp:TableCell Width="100px"><asp:Label ID="districtLabel" runat="server" Text='<%# Eval("district") %>' />
                                </asp:TableCell><asp:TableCell Width="100px"><asp:Label ID="phoneLabel" runat="server" Text='<%# Eval("phone") %>' />
                                </asp:TableCell><asp:TableCell Width="130px"><asp:Label ID="dateLabel" runat="server" Text='<%# Eval("OrderDate") %>' />
                                </asp:TableCell><asp:TableCell Width="120px"><asp:Label ID="statusLabel" runat="server" Text='<%# Eval("status") %>' />
                                </asp:TableCell><asp:TableCell Width="120px"><asp:Button ID="btn" runat="server" BorderWidth="0px" Height="30px" CssClass="btnqq" CommandArgument='<%#Eval("order_id")%>'  Width="120px" OnClick="change_status"/></asp:TableCell>
                                </asp:TableRow></asp:Table>
                                <br />
                            </div>
                        </ItemTemplate>
  ...
  <div id="footer" class="auto-style34">
