<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tennisstore.aspx.cs" Inherits="tennisstore" %>
...
<head id="Head1" runat="server">
    ...
    #search {text-align: right; width: 990px;}#search {text-align: right; width: 990px;}</style>
</head>
...
<div class="mySlides fade">
  <img src="images/tennis_banner.jpg" style="width:100%"/>
</div>

<div class="mySlides fade">
  <img src="images/tennis_banner(1).jpg" style="width:100%"/>
</div>

<div class="mySlides fade">
  <img src="images/tennis_banner(2).jpg" style="width:100%"/>
</div>
...
<div id="wrapper" style="background-image: url(images/back_tennis.jpg);
    ...
    background-size: cover;">																															
		<div id="content_inside">
			<div id="main_block">
				<h2 style="padding-bottom: 20px; font-size: 32px; color: white" class="auto-style6">TENNIS STORE</h2>
            <div>
                <div id="search">
                ...
                <strong>
                        <asp:Button ID="Category1" runat="server" ForeColor="White" BackColor="Transparent" BorderStyle="None" CssClass="auto-style8" Style="margin-left:30px; cursor:pointer; cursor:pointer" OnClick="div1_button"/>
                    </strong>
                    <asp:DataList ID="DataList1" runat="server" BackColor="Transparent" BorderColor="Maroon" BorderStyle="Ridge" BorderWidth="0px" CellPadding="15" CellSpacing="30" DataSourceID="SqlDataSource1" RepeatColumns="5" RepeatDirection="Horizontal" Width="1020px" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Size="Small" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center">                   
                ...
                <div id="div2" runat="server">
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:SportsShopOnlineConnectionString %>"></asp:SqlDataSource>
                        <strong>
                        <asp:Button ID="Category2" runat="server" ForeColor="White" BackColor="Transparent" BorderStyle="None" CssClass="auto-style8" Style="margin-left:30px; cursor:pointer;" OnClick="div2_button"/>
                    </strong>
                ...
                <div id="div3" runat="server">
                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:SportsShopOnlineConnectionString %>"></asp:SqlDataSource>
                        <strong>
                        <asp:Button ID="Category3" runat="server" ForeColor="White" BackColor="Transparent" BorderStyle="None" CssClass="auto-style8" Style="margin-left:30px; cursor:pointer;" OnClick="div3_button"/>
                    </strong>
                ...
                <div id="div4" runat="server">
                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:SportsShopOnlineConnectionString %>"></asp:SqlDataSource>
                        <strong>
                        <asp:Button ID="Category4" runat="server" ForeColor="White" BackColor="Transparent" BorderStyle="None" CssClass="auto-style8" Style="margin-left:30px; cursor:pointer;" OnClick="div4_button"/>
                    </strong>
...
<div id="footer">
			<ul class="footer_menu">
				<li><span style="font-size: 11px; text-align: left;">&nbsp;&nbsp;&nbsp;&nbsp; ©SPORTS SHOP ONLINE<span class="auto-style7">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span>&nbsp;&nbsp;</li> 
