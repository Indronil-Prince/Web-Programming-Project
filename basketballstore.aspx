<%@ Page Language="C#" AutoEventWireup="true" CodeFile="basketballstore.aspx.cs" Inherits="basketballstore" %>
...
<div class="mySlides fade">
  <img src="images/basketball_banner.jpg" style="width:100%" />
</div>

<div class="mySlides fade">
  <img src="images/basketball_banner(1).jpg" style="width:100%" />
</div>

<div class="mySlides fade">
  <img src="images/basketball_banner(2).jpg" style="width:100%" />
</div>
...
<div id="wrapper" style="background-image: url(images/back_basketball.jpg);
    ...
    background-size: cover;">																															
		<div id="content_inside">
			<div id="main_block">
				<h2 style="padding-bottom: 20px; font-size: 32px; color: white" class="auto-style6">BASKETBALL STORE</h2>
            <div>
                <div id="search">
